...
* Informationen zur Einrichtung von Azure NetApp Files und zur Erstellung eines NFS-Volumes finden Sie unter https://docs.microsoft.com/en-us/azure/azure-netapp-files/azure-netapp-files-quickstart-set-up-account-create-volumes["Azure: Azure NetApp Files einrichten und ein NFS Volume erstellen"^].
* Informationen zur Konfiguration von Azure NetApp Files und zum Hinzufügen eines SMB-Volumes finden Sie unter: https://docs.microsoft.com/en-us/azure/azure-netapp-files/azure-netapp-files-create-volumes-smb["Azure: Erstellen Sie ein SMB Volume für Azure NetApp Files"^].
