...
NOTE: Achten Sie darauf, dass Sie die für Amazon Linux und Ubuntu erforderlichen Schritte zur Knotenvorbereitung befolgen https://["Amazon Machine Images"^] (Amis) je nach EKS AMI-Typ.
