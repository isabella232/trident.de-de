...
[role="lead"]
Erfahren Sie, wie Sie ein ONTAP-Back-End mit ONTAP-SAN-Treibern vorbereiten.
...
--
'''
Version: 1 backendName: BeispieleBackend storageDriverName: ontap-san ManagementLIF: 10.0.0.1 svm: svm_nfs Benutzername: Vsadmin Passwort: Passwort
