...
Astra Trident bietet das https://github.com/NetApp/trident/tree/master/trident-installer/sample-input/pvc-samples["Einfache Definitionen von Storage-Klassen für spezifische Back-Ends"^].
