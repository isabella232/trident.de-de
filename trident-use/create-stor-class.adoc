...
Der https://kubernetes.io/docs/concepts/storage/storage-classes/["Kubernetes StorageClass-Objekt"^] Astra Trident wird als bereitstellung für diese Klasse identifiziert. Astra Trident weist Anweisungen zur Provisionierung eines Volumes aus. Beispiel:
