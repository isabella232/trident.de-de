...
----
. Nutzung `helm install` Und geben Sie einen Namen für Ihre Bereitstellung an, wie im folgenden Beispiel, wo `23.01.1` Ist die Version des Astra Trident, die Sie installieren.
+
[listing]
----
