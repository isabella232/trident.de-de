...
----
. Nutzung `helm install` Und geben Sie einen Namen für Ihre Bereitstellung und den Speicherort der Bildregistrierung oder Standorte an, wie in den folgenden Beispielen beschrieben. In den Beispielen: `23.01.0` Ist die Version des Astra Trident, die Sie installieren.
+
[role="tabbed-block"]
====
