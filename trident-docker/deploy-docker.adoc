...
----
+
Wenn Ihre Version veraltet ist, https://["Installieren oder aktualisieren Sie Ihre Installation"^].
...
----
+
Oder https://["Befolgen Sie die Anweisungen für Ihre Distribution"^].
